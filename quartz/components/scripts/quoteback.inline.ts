...
const quoteStyle = `
/* Light mode - Shenzhen Nights Light */
.quoteback-container {
  --background-color: #e5e9f0;  /* Light background */
  --border-color-normal: #b8c2cc;  /* Light border */
  --border-color-hover: #1A8CFF;  /* Shenzhen Blue */
  --author-color: #101820;  /* Dark text for contrast */
  --title-color: #1A8CFF;  /* Shenzhen Blue */
  --gototext-color: #00CC99;  /* Shenzhen Mint Green */
  --content-color: #101820;  /* Dark text */
  --internal-blockquote-color: #6B7D8C;  /* Muted text */
}

/* Dark mode - Shenzhen Nights */
.quoteback-container.dark-theme {
  --background-color: #0a0f14;  /* Shenzhen background */
  --border-color-normal: #101820;  /* Shenzhen dark border */
  --border-color-hover: #1A8CFF;  /* Shenzhen blue */
  --author-color: #d8dce0;  /* Shenzhen foreground */
  --title-color: #1A8CFF;  /* Shenzhen blue */
  --gototext-color: #00CC99;  /* Shenzhen mint green */
  --content-color: #d8dce0;  /* Shenzhen foreground */
  --internal-blockquote-color: #6B7D8C;  /* Shenzhen muted */
}
